...
void ProxyHandler(HttpListenerRequest request, HttpListenerResponse response)
{
    var hostNameEnv = System.Environment.GetEnvironmentVariable("HOSTNAME");
    var hostName = System.Net.Dns.GetHostName();

    var bytes = Encoding.UTF8.GetBytes($"ProxyHandler [\"HOSTNAME\"={hostNameEnv}] [System.Net.Dns.GetHostName() = {hostName}]");
